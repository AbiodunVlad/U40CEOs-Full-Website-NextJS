  ...
  return (
    <div className="flex flex-col text-black overflow-hidden">
      ...
      <div className="flex flex-col max-w-screen-2xl mx-auto">
        <div className="flex sm:flex-row flex-col  items-center gap-3 sm:gap-0 py-5 md:py-10 px-2 md:px-20 bg-gradient-to-t from-gray-500 to-slate-200 sm:mt-28 md:mt-24 mt-20 mb-10 sm:mb-20 w-5/6 sm:w-1/2 md:w-5/6 self-center rounded-3xl">
