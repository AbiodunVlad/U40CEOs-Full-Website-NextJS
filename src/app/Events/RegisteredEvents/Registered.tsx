          ...
          <Link href={`/Events/RegisteredEvents/${event.id}`} key={index}>
            ...
            >
              ...
              <div className="lg:w-1/2 w-full flex flex-col text-black">
                <div className="text-white md:text-lg text-sm bg-green-400 py-1 px-5 rounded-sm self-start mb-7">
                  Registered
                </div>
                ...
                <button className="bg-purple-500 text-white text-lg sm:text-2xl font-bold uppercase py-3 px-5 rounded-full lg:self-start self-stretch flex justify-center mt-auto">
                  View Details
                </button>
              </div>
            </div>
