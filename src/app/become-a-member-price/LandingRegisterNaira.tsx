...
export default function LandingRegisterNaira() {
  ...
  return (
    <div
      id="register-section"
      className="flex flex-col bg-slate-100 items-center py-5 mt-10 xl:mt-20 relative max-w-screen-2xl mx-auto w-4/5 border border-solid border-pink-500 rounded-md"
    >
