      ...
      <div className=" max-w-screen-2xl mx-auto">
        <div className="flex flex-col py-5 md:py-20 px-5 md:px-20">
          ...
          <p className="text-gray-500 text-center text-base sm:text-2xl">
            Connect, and engage in insightful discussions with diverse minds
            from all walks of
        ...
        <div className="px-5 md:px-20 flex flex-row md:flex-col-reverse lg:flex-row justify-between gap-10 w-full">
          <div className="flex flex-col w-full lg:w-2/3">
            <div className="border-solid border-gray-500 border rounded-md flex flex-col mb-5 md:mb-10">
              <div className="w-full bg-purple-600 h-1/3 rounded-t-md">
                kscd
              </div>
              ...
              <div className="bg-white border-solid border-gray-500 border rounded-t-md flex flex-col px-5 md:px-10 lg:px-16 py-7">
                ...
                <div className="mb-5">
                  <p className="text-black text-base sm:text-2xl">
                    ...
                    with eco-friendly practices? Excited to brainstorm
                    innovative solutions with fellow entrepreneurs!
                  </p>
                </div>
            ...
            <div className="flex flex-col mb-5">
              <div className="bg-white border-solid border-gray-500 border rounded-t-md flex flex-col px-5 md:px-10 lg:px-16 py-7">
                ...
                <div className="mb-5">
                  <p className="text-black text-base sm:text-2xl">
                    Hi entrepreneurs! Excited to join this buoyant community.
                    How do you maintain work-life balance while growing your
                    business? Looking forward to sharing insights and learning
                    from great minds like you.
                  </p>
                </div>
