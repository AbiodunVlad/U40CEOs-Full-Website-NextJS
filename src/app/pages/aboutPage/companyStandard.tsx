...
export default function CompanyStandard() {
  return (
    <div className="flex flex-col px-20 pb-32 justify-center">
      <div className="border-purple-600 border-2 border-solid bg-white p-20 mb-20">
        <p className="text-xs text-purple-600 mb-5">FOUNDER’S MESSAGE</p>
        <h6 className="text-black text-lg font-extrabold mb-10">
          LOREM IPSUM DOLOR
        </h6>

        <div className="flex flex-row gap-5">
          <p className="w-2/5 text-black text-xs leading-5">
      ...
      <h2 className="text-black text-xl text-center font-extrabold mb-20 uppercase">
        Our Company Standards
      </h2>

      <div className="flex flex-row gap-60 items-center">
        <div className="relative">
          <div className="bg-gray-500 w-80 h-80 rounded-full"></div>
          <div className="bg-transparent border-purple-600 border-2 w-80 h-80 rounded-full -right-10 top-5 absolute"></div>
        </div>
