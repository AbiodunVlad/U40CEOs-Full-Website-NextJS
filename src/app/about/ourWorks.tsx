...
export default function OurWorks() {
  return (
    <div className="flex flex-col items-center justify-center px-4 sm:px-8 md:px-20 py-10 sm:py-16 md:py-20">
      ...
      <div className="flex flex-col-reverse md:flex-row gap-10 items-center justify-center mb-10 sm:mb-16 md:mb-20">
      ...
      <div className="flex flex-col md:flex-row gap-10 items-center justify-center mb-10 sm:mb-16 md:mb-20">
        <div className="w-full md:w-3/5">
          <iframe
            src="https://www.youtube.com/embed/6VSyCoBCzXY?si=Atwhzufq9IBnufba"
            className="w-full h-48"
