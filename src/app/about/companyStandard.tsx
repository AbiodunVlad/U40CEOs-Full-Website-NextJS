...
export default function CompanyStandard() {
  return (
    <div className="flex flex-col px-4 sm:px-8 md:px-20 pb-16 sm:pb-24 md:pb-32 justify-center">
      <div className="border-purple-600 border-4 border-solid bg-white  mb-10 sm:mb-16 md:mb-20">
        <div className="flex flex-col pt-6 px-6 sm:pt-12 sm:px-12 md:pt-10 md:px-10">
          <p className="text-base sm:text-2xl text-purple-600 mb-3 sm:mb-4 md:mb-5">
            FOUNDER’S MESSAGE
          </p>
        ...
        <div className="flex flex-col  gap-5 h-auto p-6 sm:p-12 md:p-10">
          <div className="flex flex-col sm:flex-row w-full">
            <div className="flex flex-col w-full sm:w-1/2 mb-5">
              <p className="w-full text-black text-base sm:text-2xl leading-5 mb-3">
                ...
                failure? These numbers are stark, but they highlight the
                critical challenges we’re here to overcome.
              </p>
          ...
          <div>
            ...
            <p className="w-full text-black text-base sm:text-2xl leading-5">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-10 sm:gap-20 md:gap-40 items-center">
        <div className="w-full lg:w-1/2 relative flex items-center justify-center mb-40 md:mb-10 lg:mb-0">
          <Image src="/images/salesGIF.svg" alt="" width={800} height={800} />
        ...
        <div className="w-full lg:w-1/2 flex flex-col">
          <div className="mb-5 sm:mb-7 md:mb-10">
            <p className="text-3xl text-purple-600 font-bold">Vision</p>
          ...
          <div>
            <p className="text-3xl text-purple-600 font-bold">Mission</p>
            <p className="text-base sm:text-2xl text-black leading-5">
