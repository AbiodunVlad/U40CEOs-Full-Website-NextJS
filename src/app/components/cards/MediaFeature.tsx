...
export default function MediaFeature() {
  return (
    <div className="bg-gradient-to-r from-pink-500 to-purple-500 pt-10 pb-5 px-5 flex flex-row gap-3 w-5/6">
      <div className="">
      ...
      <div className="w-2/3 flex flex-col justify-between">
        <div className="flex flex-col flex-grow">
          <p className="text-white text-2xl font-bold mb-2">MEDIA FEATURE</p>
          <p className="text-sm text-white leading-1 mb-auto w-1/3">
